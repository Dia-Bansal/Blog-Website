...
import React, { useState, useEffect, useContext } from 'react';
import blog from './save.jpg'

import { TextField, Box, Button, Typography, styled ,CardMedia} from '@mui/material';
import { useNavigate } from 'react-router-dom';
...
const Login = ({ isUserAuthenticated }) => {
    ...
    const imageURL = 'https://wallpaperaccess.com/full/6132195.png';
    ...
    const loginUser = async () => {
        console.log("Heloo startedted");
        let response = await API.userLogin(login);
        console.log("Heloo ended");
